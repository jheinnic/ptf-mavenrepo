...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package name.jchein.portfolio.services.${parentArtifactId}.grpc.server;
...
import name.jchein.portfolio.services.${parentArtifactId}.backend.IExampleDomainService;
